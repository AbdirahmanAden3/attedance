...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white  bg-gradient-primary" href="./pages/dashboard.html">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary"  href="./student.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./attedance.php">
            ...
            <span class="nav-link-text ms-1">Attedace</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="view.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <span class="material-symbols-outlined">visibility</span>
            </div>
            <span class="nav-link-text ms-1">view attedance</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="parents.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="class.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
      ...
      $id = $_GET['id'];
        ...
        #iid where ku xiga waa kan Databse
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="sex" value='<?php echo $row['sex']?>'>
                    </div>
...
if(isset($_POST['save'])){
  ...
  $q = mysqli_query($con, "UPDATE student SET name  = '$nme', mother = '$m',  sex = '$se', Age = '$ag', class = '$cla', Section = '$se'  WHERE id = '$id'");
  if($q){
  //  header('location: ./student.php');
   echo "<script>alert('hellllllllllll')</script>";
